...
try {
    ...
    if (isset($transcript['content_safety_labels'])) {
        $contentSafetyLabels = $transcript['content_safety_labels'];
        if (isset($contentSafetyLabels['results'])) {
            foreach ($contentSafetyLabels['results'] as $result) {
                if (isset($result['labels'])) {
                    foreach ($result['labels'] as $label) {
                        if ($label['label'] === "hate_speech") {
                            echo "\nHate speech detected: " . $label['confidence'];
                        }
                    }
                }
            }
