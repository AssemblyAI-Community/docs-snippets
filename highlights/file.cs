...
public class Program
{
    public static async Task Main(string[] args)
    {
        ...
        try
        {
            ...
            // Print the auto_highlights_result results to the console
            if (transcript.auto_highlights_result.status == "success")
            {
                Console.WriteLine("Auto Highlights Results:\n");
                foreach (var result in transcript.auto_highlights_result.results)
                {
            ...
            {
                Console.WriteLine("Auto highlights results not available.");
            }
        }
        catch (Exception ex)
        {
